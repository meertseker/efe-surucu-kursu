  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-white/5 rounded-xl backdrop-blur-sm">
              <p className="text-sm text-gray-400">
                ...
                <a href={`tel:${phone}`} className="text-blue-400 hover:text-blue-300 font-semibold">
                  {phone}
                </a>
              </p>
            </div>
      ...
      <button
        ...
        className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-br from-blue-600 to-purple-600 text-white rounded-full shadow-lg hover:scale-110 transition-transform duration-300 flex items-center justify-center"
